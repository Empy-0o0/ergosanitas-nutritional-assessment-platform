...
import DieteticsForm from '@/components/evaluations/DieteticsForm'
...
export default function DieteticsPage() {
  ...
  const handleSave = (data: any) => {
    if (selectedAthlete) {
      // Update athlete with dietetics data
      const updatedAthlete = {
        ...selectedAthlete,
        dietetics: data
      }
      DataStorage.saveAthlete(updatedAthlete)
      alert('Datos dietéticos guardados exitosamente')
    }
  }
      ...
      <header className="bg-gradient-to-r from-purple-600 to-purple-800 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold">Evaluación ABCD - D: Dietética</h1>
              <p className="text-purple-100 text-sm">Análisis de consumo alimentario y hábitos nutricionales</p>
            </div>
            ...
            <div>
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900 mb-2">
                  Evaluación Dietética - {selectedAthlete.fullName}
                </h2>
              ...
              <DieteticsForm
                ...
                weight={selectedAthlete.anthropometry?.weight || 50}
                height={selectedAthlete.anthropometry?.height || 160}
                sport="futbol"
                initialData={selectedAthlete.dietetics}
                onSave={handleSave}
              />
            </div>
          ) : (
            <div className="text-center py-12">
              ...
              {athletes.length === 0 ? (
                ...
                <p className="text-gray-600">
                  Seleccione un deportista para comenzar la evaluación dietética.
                </p>
              )}
            </div>
          )}
