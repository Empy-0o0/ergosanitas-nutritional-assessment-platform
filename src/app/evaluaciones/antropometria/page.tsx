...
import AnthropometryForm from '@/components/evaluations/AnthropometryForm'
...
export default function AnthropometryPage() {
  ...
  const handleSave = (data: any) => {
    if (selectedAthlete) {
      // Update athlete with anthropometry data
      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold">Evaluación ABCD - A: Antropometría</h1>
              <p className="text-blue-100 text-sm">Medición de composición corporal y dimensiones físicas</p>
            </div>
            ...
            <div>
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900 mb-2">
                  Evaluación Antropométrica - {selectedAthlete.fullName}
                </h2>
              ...
              <AnthropometryForm
                ...
                initialData={selectedAthlete.anthropometry}
                onSave={handleSave}
              />
            </div>
          ) : (
            <div className="text-center py-12">
              ...
              {athletes.length === 0 ? (
                ...
                <p className="text-gray-600">
                  Seleccione un deportista para comenzar la evaluación antropométrica.
                </p>
              )}
            </div>
          )}
