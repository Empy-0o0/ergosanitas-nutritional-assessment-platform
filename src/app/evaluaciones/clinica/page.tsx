...
import ClinicalForm from '@/components/evaluations/ClinicalForm'
...
export default function ClinicalPage() {
  ...
  const handleSave = (data: any) => {
    if (selectedAthlete) {
      // Update athlete with clinical data
      ...
      <header className="bg-gradient-to-r from-orange-600 to-orange-800 text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold">Evaluación ABCD - C: Clínica</h1>
              <p className="text-orange-100 text-sm">Evaluación de signos, síntomas y estado funcional</p>
            </div>
          ...
          {selectedAthlete ? (
            <div>
              <div className="mb-6">
                <h2 className="text-xl font-bold text-gray-900 mb-2">
                  Evaluación Clínica - {selectedAthlete.fullName}
                </h2>
              ...
              <ClinicalForm
                ...
                initialData={selectedAthlete.clinical}
                onSave={handleSave}
              />
            </div>
          ) : (
            <div className="text-center py-12">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-orange-600 text-2xl font-bold">C</span>
              </div>
              ...
              {athletes.length === 0 ? (
                ...
                <p className="text-gray-600">
                  Seleccione un deportista para comenzar la evaluación clínica.
                </p>
              )}
            </div>
          )}
